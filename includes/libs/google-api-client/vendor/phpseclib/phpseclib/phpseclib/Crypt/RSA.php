 ...
 */
namespace FluentMailLib\phpseclib\Crypt;

use FluentMailLib\phpseclib\Math\BigInteger;
/**
...
class RSA
{
    ...
    function __construct()
    {
        ...
        if (!\defined('FluentMailLib\\CRYPT_RSA_MODE')) {
            switch (\true) {
                ...
                case \defined('FluentMailLib\\MATH_BIGINTEGER_OPENSSL_DISABLE'):
                    \define('FluentMailLib\\CRYPT_RSA_MODE', self::MODE_INTERNAL);
                    break;
                case \extension_loaded('openssl') && \file_exists($this->configFile):
                    ...
                    switch (\true) {
                        ...
                        case \version_compare($versions['Header'], '1.0.0') >= 0 && \version_compare($versions['Library'], '1.0.0') >= 0:
                            \define('FluentMailLib\\CRYPT_RSA_MODE', self::MODE_OPENSSL);
                            break;
                        default:
                            \define('FluentMailLib\\CRYPT_RSA_MODE', self::MODE_INTERNAL);
    ...
    {
        if (!\defined('FluentMailLib\\CRYPT_RSA_EXPONENT')) {
            // http://en.wikipedia.org/wiki/65537_%28number%29
            \define('FluentMailLib\\CRYPT_RSA_EXPONENT', '65537');
        }
        ...
        if (!\defined('FluentMailLib\\CRYPT_RSA_SMALLEST_PRIME')) {
            \define('FluentMailLib\\CRYPT_RSA_SMALLEST_PRIME', 4096);
        }
    ...
    function _exponentiate($x)
    {
        ...
        if (\defined('FluentMailLib\\CRYPT_RSA_DISABLE_BLINDING')) {
    ...
    function _rsaes_pkcs1_v1_5_encrypt($m)
    {
        ...
        if (\defined('FluentMailLib\\CRYPT_RSA_PKCS15_COMPAT') && (!isset($this->publicExponent) || $this->exponent !== $this->publicExponent)) {
            $type = 1;
