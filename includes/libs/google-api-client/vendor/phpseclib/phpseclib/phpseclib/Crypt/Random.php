...
class Random
{
    ...
    static function string($length)
    {
        ...
        if ($crypto === \false) {
            ...
            switch (\true) {
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\AES'):
                    $crypto = new AES(Base::MODE_CTR);
                    break;
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\Twofish'):
                    $crypto = new Twofish(Base::MODE_CTR);
                    break;
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\Blowfish'):
                    $crypto = new Blowfish(Base::MODE_CTR);
                    break;
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\TripleDES'):
                    $crypto = new TripleDES(Base::MODE_CTR);
                    break;
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\DES'):
                    $crypto = new DES(Base::MODE_CTR);
                    break;
                case \class_exists('FluentMailLib\\phpseclib\\Crypt\\RC4'):
                    $crypto = new RC4();
                    break;
                default:
...
if (!\function_exists('FluentMailLib\\phpseclib_safe_serialize')) {
    /**
