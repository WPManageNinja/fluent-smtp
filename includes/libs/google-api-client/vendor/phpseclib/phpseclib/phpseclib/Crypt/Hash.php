...
class Hash
{
    ...
    {
        if (!\defined('FluentMailLib\\CRYPT_HASH_MODE')) {
            switch (\true) {
                case \extension_loaded('hash'):
                    \define('FluentMailLib\\CRYPT_HASH_MODE', self::MODE_HASH);
                    break;
                case \extension_loaded('mhash'):
                    \define('FluentMailLib\\CRYPT_HASH_MODE', self::MODE_MHASH);
                    break;
                default:
                    \define('FluentMailLib\\CRYPT_HASH_MODE', self::MODE_INTERNAL);
            }
        }
        $this->setHash($hash);
    }
