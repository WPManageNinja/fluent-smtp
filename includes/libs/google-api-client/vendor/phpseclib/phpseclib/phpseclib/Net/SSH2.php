...
use FluentMail\phpseclib3\Crypt\Common\SymmetricKey;
...
use FluentMail\phpseclib3\Crypt\Rijndael;
use FluentMail\phpseclib3\Crypt\RSA;
use FluentMail\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use FluentMail\phpseclib3\Crypt\Twofish;
use FluentMail\phpseclib3\Exception\ConnectionClosedException;
use FluentMail\phpseclib3\Exception\InsufficientSetupException;
use FluentMail\phpseclib3\Exception\NoSupportedAlgorithmsException;
use FluentMail\phpseclib3\Exception\UnableToConnectException;
