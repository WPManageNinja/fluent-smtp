...
namespace FluentMail\Google\Service\IdentityToolkit\Resource;

use FluentMail\Google\Service\IdentityToolkit\CreateAuthUriResponse;
use FluentMail\Google\Service\IdentityToolkit\DeleteAccountResponse;
use FluentMail\Google\Service\IdentityToolkit\DownloadAccountResponse;
use FluentMail\Google\Service\IdentityToolkit\EmailLinkSigninResponse;
use FluentMail\Google\Service\IdentityToolkit\GetAccountInfoResponse;
use FluentMail\Google\Service\IdentityToolkit\GetOobConfirmationCodeResponse;
use FluentMail\Google\Service\IdentityToolkit\GetRecaptchaParamResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyCreateAuthUriRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyDeleteAccountRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyDownloadAccountRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyEmailLinkSigninRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetAccountInfoRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetProjectConfigResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetPublicKeysResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyResetPasswordRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySendVerificationCodeRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySendVerificationCodeResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetAccountInfoRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetProjectConfigRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetProjectConfigResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignOutUserRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignOutUserResponse;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignupNewUserRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyUploadAccountRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyAssertionRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyCustomTokenRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPasswordRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest;
use FluentMail\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse;
use FluentMail\Google\Service\IdentityToolkit\Relyingparty as RelyingpartyModel;
use FluentMail\Google\Service\IdentityToolkit\ResetPasswordResponse;
use FluentMail\Google\Service\IdentityToolkit\SetAccountInfoResponse;
use FluentMail\Google\Service\IdentityToolkit\SignupNewUserResponse;
use FluentMail\Google\Service\IdentityToolkit\UploadAccountResponse;
use FluentMail\Google\Service\IdentityToolkit\VerifyAssertionResponse;
use FluentMail\Google\Service\IdentityToolkit\VerifyCustomTokenResponse;
use FluentMail\Google\Service\IdentityToolkit\VerifyPasswordResponse;
