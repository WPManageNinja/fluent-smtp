...
class YoutubeDiscoveryLegosLegosAnnotations extends \Google\Collection
{
  ...
  /**
   * @return YoutubeDiscoveryLegosLegosAnnotation[]
   */
...
class_alias(YoutubeDiscoveryLegosLegosAnnotations::class, 'Google_Service_Contentwarehouse_YoutubeDiscoveryLegosLegosAnnotations');
