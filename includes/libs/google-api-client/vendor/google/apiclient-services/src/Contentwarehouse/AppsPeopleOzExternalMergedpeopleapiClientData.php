...
class AppsPeopleOzExternalMergedpeopleapiClientData extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiClientData::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiClientData');
