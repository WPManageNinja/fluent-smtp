...
class HomeGraphCommonRoutingTable extends \Google\Collection
{
   ...
   */
  public function setSupportedRoutes($supportedRoutes)
  {
    $this->supportedRoutes = $supportedRoutes;
  }
  /**
   * @return HomeGraphCommonRoute[]
   */
  public function getSupportedRoutes()
  {
...
class_alias(HomeGraphCommonRoutingTable::class, 'Google_Service_Contentwarehouse_HomeGraphCommonRoutingTable');
