...
class BiasingPerDocData extends \Google\Collection
{
  ...
  /**
   * @param BiasingPerDocDataBiasingField[]
   */
  ...
  /**
   * @return BiasingPerDocDataBiasingField[]
   */
...
class_alias(BiasingPerDocData::class, 'Google_Service_Contentwarehouse_BiasingPerDocData');
