...
class RepositoryWebrefRefconRefconDocumentMetadata extends \Google\Model
{
   ...
   */
  public function setQueryStats(RepositoryWebrefRefconQueryStats $queryStats)
  {
    $this->queryStats = $queryStats;
  }
  /**
   * @return RepositoryWebrefRefconQueryStats
   */
...
class_alias(RepositoryWebrefRefconRefconDocumentMetadata::class, 'Google_Service_Contentwarehouse_RepositoryWebrefRefconRefconDocumentMetadata');
