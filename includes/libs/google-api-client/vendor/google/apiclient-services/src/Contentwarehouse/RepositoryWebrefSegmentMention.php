...
class RepositoryWebrefSegmentMention extends \Google\Model
{
   ...
   */
  public function setMention(RepositoryWebrefMention $mention)
  {
...
class_alias(RepositoryWebrefSegmentMention::class, 'Google_Service_Contentwarehouse_RepositoryWebrefSegmentMention');
