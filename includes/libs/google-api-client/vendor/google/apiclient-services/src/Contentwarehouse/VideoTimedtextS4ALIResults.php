...
class VideoTimedtextS4ALIResults extends \Google\Collection
{
  ...
  /**
   * @param VideoTimedtextS4LangScore[]
   */
  public function setLangResults($langResults)
  {
    $this->langResults = $langResults;
  }
  /**
   * @return VideoTimedtextS4LangScore[]
   */
  public function getLangResults()
  {
    return $this->langResults;
  }
  /**
   * @param string
   */
...
class_alias(VideoTimedtextS4ALIResults::class, 'Google_Service_Contentwarehouse_VideoTimedtextS4ALIResults');
