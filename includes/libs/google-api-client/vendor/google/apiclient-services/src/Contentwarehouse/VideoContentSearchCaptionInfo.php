...
class VideoContentSearchCaptionInfo extends \Google\Collection
{
   ...
   */
  public function setAsrCaption($asrCaption)
  {
    $this->asrCaption = $asrCaption;
  }
  /**
   * @return VideoContentSearchAsrCaption[]
   */
  public function getAsrCaption()
  {
    return $this->asrCaption;
  }
  /**
...
class_alias(VideoContentSearchCaptionInfo::class, 'Google_Service_Contentwarehouse_VideoContentSearchCaptionInfo');
