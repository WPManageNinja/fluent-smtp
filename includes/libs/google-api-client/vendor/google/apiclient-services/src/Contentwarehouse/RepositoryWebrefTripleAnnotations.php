...
class RepositoryWebrefTripleAnnotations extends \Google\Collection
{
  ...
  /**
   * @return RepositoryWebrefTripleAnnotation[]
   */
...
class_alias(RepositoryWebrefTripleAnnotations::class, 'Google_Service_Contentwarehouse_RepositoryWebrefTripleAnnotations');
