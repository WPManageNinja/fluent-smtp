...
class SecurityCredentialsRbacRoleProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsRbacRoleProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsRbacRoleProto');
