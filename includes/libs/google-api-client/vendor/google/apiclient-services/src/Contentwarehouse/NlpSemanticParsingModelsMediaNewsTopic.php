...
class NlpSemanticParsingModelsMediaNewsTopic extends \Google\Model
{
...
class_alias(NlpSemanticParsingModelsMediaNewsTopic::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingModelsMediaNewsTopic');
