...
class ImageRepositoryVenomProcessingInfo extends \Google\Collection
{
   ...
   */
  public function setVenomStatus($venomStatus)
  {
    $this->venomStatus = $venomStatus;
  }
  /**
   * @return ImageRepositoryVenomStatus[]
   */
  public function getVenomStatus()
  {
    return $this->venomStatus;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ImageRepositoryVenomProcessingInfo::class, 'Google_Service_Contentwarehouse_ImageRepositoryVenomProcessingInfo');
