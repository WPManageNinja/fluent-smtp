...
class SecurityCredentialsContactGroupProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsContactGroupProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsContactGroupProto');
