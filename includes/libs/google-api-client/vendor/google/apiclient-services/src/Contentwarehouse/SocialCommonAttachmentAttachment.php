...
class SocialCommonAttachmentAttachment extends \Google\Model
{
  ...
  /**
   * @param EmbedsEmbedClientItem
   */
  public function setEmbedItem(EmbedsEmbedClientItem $embedItem)
  {
    $this->embedItem = $embedItem;
  }
  /**
   * @return EmbedsEmbedClientItem
   */
...
class_alias(SocialCommonAttachmentAttachment::class, 'Google_Service_Contentwarehouse_SocialCommonAttachmentAttachment');
