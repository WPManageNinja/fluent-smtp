...
class_alias(RepositoryWebrefLightweightTokensPerNameLightweightToken::class, 'Google_Service_Contentwarehouse_RepositoryWebrefLightweightTokensPerNameLightweightToken');
