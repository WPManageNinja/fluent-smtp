...
class AppsPeopleOzExternalMergedpeopleapiOtherKeyword extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiOtherKeyword::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiOtherKeyword');
