...
class AppsPeopleOzExternalMergedpeopleapiRelationshipStatus extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiRelationshipStatus::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiRelationshipStatus');
