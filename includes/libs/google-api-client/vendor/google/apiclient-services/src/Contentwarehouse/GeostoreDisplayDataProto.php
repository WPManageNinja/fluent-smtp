...
class GeostoreDisplayDataProto extends \Google\Model
{
   ...
   */
  public function setDisplayLocation(GeostorePointProto $displayLocation)
  {
...
class_alias(GeostoreDisplayDataProto::class, 'Google_Service_Contentwarehouse_GeostoreDisplayDataProto');
