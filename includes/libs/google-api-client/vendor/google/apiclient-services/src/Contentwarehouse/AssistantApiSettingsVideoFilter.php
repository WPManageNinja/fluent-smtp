...
class AssistantApiSettingsVideoFilter extends \Google\Collection
{
  protected $collection_key = 'whitelistedProviders';
  /**
   * @var string
   */
  public $autoplayToggleState;
  /**
   * @var string[]
   */
   ...
   * @param string
   */
  public function setAutoplayToggleState($autoplayToggleState)
  {
   ...
   * @return string
   */
  public function getAutoplayToggleState()
  {
    return $this->autoplayToggleState;
  }
  /**
   * @param string[]
   */
...
class_alias(AssistantApiSettingsVideoFilter::class, 'Google_Service_Contentwarehouse_AssistantApiSettingsVideoFilter');
