...
class ResearchScamCoscamDisjunction extends \Google\Collection
{
...
class_alias(ResearchScamCoscamDisjunction::class, 'Google_Service_Contentwarehouse_ResearchScamCoscamDisjunction');
