...
class SecurityCredentialsCircleProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsCircleProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsCircleProto');
