...
class SecurityCredentialsPostiniUserProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsPostiniUserProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsPostiniUserProto');
