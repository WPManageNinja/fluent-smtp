...
class RepositoryWebrefPreprocessingUrlMatchingMetadata extends \Google\Collection
{
  ...
  /**
   * @return RepositoryWebrefPreprocessingUrlSourceInfo[]
   */
...
class_alias(RepositoryWebrefPreprocessingUrlMatchingMetadata::class, 'Google_Service_Contentwarehouse_RepositoryWebrefPreprocessingUrlMatchingMetadata');
