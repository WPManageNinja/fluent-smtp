...
class QualityQrewriteCandidateId extends \Google\Collection
{
  ...
  /**
   * @return QualityQrewriteCandidateIdField[]
   */
...
class_alias(QualityQrewriteCandidateId::class, 'Google_Service_Contentwarehouse_QualityQrewriteCandidateId');
