...
class ImageSafesearchContentOffensiveSymbolDetection extends \Google\Collection
{
  ...
  /**
   * @return ImageSafesearchContentOffensiveSymbolMatch[]
   */
...
class_alias(ImageSafesearchContentOffensiveSymbolDetection::class, 'Google_Service_Contentwarehouse_ImageSafesearchContentOffensiveSymbolDetection');
