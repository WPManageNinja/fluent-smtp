...
class IndexingConverterRichContentData extends \Google\Collection
{
  ...
  /**
   * @return IndexingConverterRichContentDataRange[]
   */
...
class_alias(IndexingConverterRichContentData::class, 'Google_Service_Contentwarehouse_IndexingConverterRichContentData');
