...
class AppsPeopleOzExternalMergedpeopleapiRelationshipInterest extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiRelationshipInterest::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiRelationshipInterest');
