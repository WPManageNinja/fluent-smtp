...
class QualityProductProductSiteData extends \Google\Collection
{
  ...
  /**
   * @return QualityProductProductSiteDataLocaleData[]
   */
...
class_alias(QualityProductProductSiteData::class, 'Google_Service_Contentwarehouse_QualityProductProductSiteData');
