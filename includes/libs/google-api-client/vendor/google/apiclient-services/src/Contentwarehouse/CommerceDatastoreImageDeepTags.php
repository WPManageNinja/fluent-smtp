...
class CommerceDatastoreImageDeepTags extends \Google\Collection
{
   ...
   */
  public function setModelOutputs($modelOutputs)
  {
    $this->modelOutputs = $modelOutputs;
  }
  /**
   * @return CommerceDatastoreImageDeepTagsModelOutput[]
   */
  public function getModelOutputs()
  {
...
class_alias(CommerceDatastoreImageDeepTags::class, 'Google_Service_Contentwarehouse_CommerceDatastoreImageDeepTags');
