...
class OceanVolumeDisplayDetails extends \Google\Model
{
  /**
   * @var int
   */
...
class_alias(OceanVolumeDisplayDetails::class, 'Google_Service_Contentwarehouse_OceanVolumeDisplayDetails');
