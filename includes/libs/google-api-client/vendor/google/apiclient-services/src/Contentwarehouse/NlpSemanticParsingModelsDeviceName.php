...
class NlpSemanticParsingModelsDeviceName extends \Google\Model
{
...
class_alias(NlpSemanticParsingModelsDeviceName::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingModelsDeviceName');
