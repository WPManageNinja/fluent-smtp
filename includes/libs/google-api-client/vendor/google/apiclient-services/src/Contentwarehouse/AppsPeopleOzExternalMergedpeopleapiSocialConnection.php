...
class AppsPeopleOzExternalMergedpeopleapiSocialConnection extends \Google\Collection
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiSocialConnection::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiSocialConnection');
