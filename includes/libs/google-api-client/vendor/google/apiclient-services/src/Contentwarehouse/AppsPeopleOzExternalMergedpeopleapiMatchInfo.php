...
class AppsPeopleOzExternalMergedpeopleapiMatchInfo extends \Google\Collection
{
  ...
  /**
   * @param AppsPeopleOzExternalMergedpeopleapiMatchInfoLookupTokenMatch[]
   */
  ...
  /**
   * @return AppsPeopleOzExternalMergedpeopleapiMatchInfoLookupTokenMatch[]
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiMatchInfo::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiMatchInfo');
