...
class AppsPeopleOzExternalMergedpeopleapiProfileUrl extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiProfileUrl::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiProfileUrl');
