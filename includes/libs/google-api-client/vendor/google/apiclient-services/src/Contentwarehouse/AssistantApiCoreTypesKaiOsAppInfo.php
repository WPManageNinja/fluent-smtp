...
class AssistantApiCoreTypesKaiOsAppInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiCoreTypesKaiOsAppInfo::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesKaiOsAppInfo');
