...
class NlpSemanticParsingModelsMediaMusicGenre extends \Google\Model
{
...
class_alias(NlpSemanticParsingModelsMediaMusicGenre::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingModelsMediaMusicGenre');
