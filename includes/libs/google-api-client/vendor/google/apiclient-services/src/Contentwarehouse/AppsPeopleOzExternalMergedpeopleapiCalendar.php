...
class AppsPeopleOzExternalMergedpeopleapiCalendar extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiCalendar::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiCalendar');
