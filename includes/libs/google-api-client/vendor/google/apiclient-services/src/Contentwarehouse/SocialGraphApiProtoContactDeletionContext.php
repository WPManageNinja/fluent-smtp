...
class SocialGraphApiProtoContactDeletionContext extends \Google\Model
{
...
class_alias(SocialGraphApiProtoContactDeletionContext::class, 'Google_Service_Contentwarehouse_SocialGraphApiProtoContactDeletionContext');
