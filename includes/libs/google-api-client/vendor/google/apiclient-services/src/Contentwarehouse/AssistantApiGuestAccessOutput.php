...
class AssistantApiGuestAccessOutput extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiGuestAccessOutput::class, 'Google_Service_Contentwarehouse_AssistantApiGuestAccessOutput');
