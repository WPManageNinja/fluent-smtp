...
class AppsPeopleOzExternalMergedpeopleapiSipAddress extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiSipAddress::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiSipAddress');
