...
class AppsPeopleOzExternalMergedpeopleapiCertifiedBornBefore extends \Google\Model
{
  /**
   * @var string
   */
   ...
   * @param string
   */
  public function setBornBefore($bornBefore)
  {
...
class_alias(AppsPeopleOzExternalMergedpeopleapiCertifiedBornBefore::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiCertifiedBornBefore');
