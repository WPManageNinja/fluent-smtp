...
class AssistantApiCoreTypesChromeOsAppInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiCoreTypesChromeOsAppInfo::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesChromeOsAppInfo');
