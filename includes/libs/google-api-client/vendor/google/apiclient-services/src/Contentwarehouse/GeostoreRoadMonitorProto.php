...
class GeostoreRoadMonitorProto extends \Google\Collection
{
   ...
   */
  public function setMonitoredRoad($monitoredRoad)
  {
    $this->monitoredRoad = $monitoredRoad;
  }
  /**
   * @return GeostoreFeatureIdProto[]
   */
  public function getMonitoredRoad()
  {
    return $this->monitoredRoad;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GeostoreRoadMonitorProto::class, 'Google_Service_Contentwarehouse_GeostoreRoadMonitorProto');
