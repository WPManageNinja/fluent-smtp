...
class GeostoreCurveConnectionProtoBezierParams extends \Google\Collection
{
  ...
  /**
   * @return GeostoreCurveConnectionProtoBezierParamsControlPoint[]
   */
...
class_alias(GeostoreCurveConnectionProtoBezierParams::class, 'Google_Service_Contentwarehouse_GeostoreCurveConnectionProtoBezierParams');
