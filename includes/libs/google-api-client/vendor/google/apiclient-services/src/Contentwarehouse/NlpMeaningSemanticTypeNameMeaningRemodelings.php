...
class NlpMeaningSemanticTypeNameMeaningRemodelings extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(NlpMeaningSemanticTypeNameMeaningRemodelings::class, 'Google_Service_Contentwarehouse_NlpMeaningSemanticTypeNameMeaningRemodelings');
