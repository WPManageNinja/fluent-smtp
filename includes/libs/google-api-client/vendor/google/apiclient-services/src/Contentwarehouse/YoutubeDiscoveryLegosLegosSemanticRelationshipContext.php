...
class YoutubeDiscoveryLegosLegosSemanticRelationshipContext extends \Google\Model
{
   ...
   */
  public function setSubject(YoutubeDiscoveryLegosLegosEntity $subject)
  {
...
class_alias(YoutubeDiscoveryLegosLegosSemanticRelationshipContext::class, 'Google_Service_Contentwarehouse_YoutubeDiscoveryLegosLegosSemanticRelationshipContext');
