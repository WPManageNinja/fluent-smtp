...
class AppsPeopleOzExternalMergedpeopleapiInterest extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiInterest::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiInterest');
