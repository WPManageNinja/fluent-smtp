...
class AppsPeopleOzExternalMergedpeopleapiUserDefined extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiUserDefined::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiUserDefined');
