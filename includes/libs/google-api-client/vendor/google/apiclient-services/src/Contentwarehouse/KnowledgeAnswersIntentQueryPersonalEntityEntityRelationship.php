...
class KnowledgeAnswersIntentQueryPersonalEntityEntityRelationship extends \Google\Collection
{
...
class_alias(KnowledgeAnswersIntentQueryPersonalEntityEntityRelationship::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersIntentQueryPersonalEntityEntityRelationship');
