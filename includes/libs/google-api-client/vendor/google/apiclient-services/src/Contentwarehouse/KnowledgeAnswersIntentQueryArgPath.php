...
class KnowledgeAnswersIntentQueryArgPath extends \Google\Collection
{
  ...
  /**
   * @return KnowledgeAnswersIntentQueryArgPathComponent[]
   */
...
class_alias(KnowledgeAnswersIntentQueryArgPath::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersIntentQueryArgPath');
