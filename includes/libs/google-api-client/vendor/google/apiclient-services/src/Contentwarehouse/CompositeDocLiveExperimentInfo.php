...
class CompositeDocLiveExperimentInfo extends \Google\Collection
{
   ...
   */
  public function setPerLiveExperimentInfo($perLiveExperimentInfo)
  {
    $this->perLiveExperimentInfo = $perLiveExperimentInfo;
  }
  /**
   * @return CompositeDocLiveExperimentInfoPerLiveExperimentInfo[]
   */
  public function getPerLiveExperimentInfo()
  {
    return $this->perLiveExperimentInfo;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(CompositeDocLiveExperimentInfo::class, 'Google_Service_Contentwarehouse_CompositeDocLiveExperimentInfo');
