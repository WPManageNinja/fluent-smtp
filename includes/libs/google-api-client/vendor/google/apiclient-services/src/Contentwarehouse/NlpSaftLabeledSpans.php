...
class NlpSaftLabeledSpans extends \Google\Collection
{
   ...
   */
  public function setLabeledSpan($labeledSpan)
  {
    $this->labeledSpan = $labeledSpan;
  }
  /**
   * @return NlpSaftLabeledSpan[]
   */
  public function getLabeledSpan()
  {
    return $this->labeledSpan;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(NlpSaftLabeledSpans::class, 'Google_Service_Contentwarehouse_NlpSaftLabeledSpans');
