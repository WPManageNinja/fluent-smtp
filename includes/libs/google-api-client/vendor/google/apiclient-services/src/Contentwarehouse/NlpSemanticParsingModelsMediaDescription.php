...
class NlpSemanticParsingModelsMediaDescription extends \Google\Model
{
...
class_alias(NlpSemanticParsingModelsMediaDescription::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingModelsMediaDescription');
