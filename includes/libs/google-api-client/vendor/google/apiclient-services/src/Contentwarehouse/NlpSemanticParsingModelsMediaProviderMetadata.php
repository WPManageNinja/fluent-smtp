...
class NlpSemanticParsingModelsMediaProviderMetadata extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(NlpSemanticParsingModelsMediaProviderMetadata::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingModelsMediaProviderMetadata');
