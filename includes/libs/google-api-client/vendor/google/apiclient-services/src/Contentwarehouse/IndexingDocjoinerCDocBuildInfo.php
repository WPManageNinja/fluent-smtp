...
class IndexingDocjoinerCDocBuildInfo extends \Google\Model
{
   ...
   */
  public function setExtraMessage(Proto2BridgeMessageSet $extraMessage)
  {
...
class_alias(IndexingDocjoinerCDocBuildInfo::class, 'Google_Service_Contentwarehouse_IndexingDocjoinerCDocBuildInfo');
