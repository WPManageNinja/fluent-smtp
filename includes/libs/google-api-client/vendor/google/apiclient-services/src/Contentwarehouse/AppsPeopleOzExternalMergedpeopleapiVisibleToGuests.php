...
class AppsPeopleOzExternalMergedpeopleapiVisibleToGuests extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiVisibleToGuests::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiVisibleToGuests');
