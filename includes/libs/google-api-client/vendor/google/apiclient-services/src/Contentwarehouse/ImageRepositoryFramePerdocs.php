...
class ImageRepositoryFramePerdocs extends \Google\Collection
{
   ...
   */
  public function setFramePerdoc($framePerdoc)
  {
    $this->framePerdoc = $framePerdoc;
  }
  /**
   * @return ImageRepositoryFramePerdoc[]
   */
  public function getFramePerdoc()
  {
    return $this->framePerdoc;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ImageRepositoryFramePerdocs::class, 'Google_Service_Contentwarehouse_ImageRepositoryFramePerdocs');
