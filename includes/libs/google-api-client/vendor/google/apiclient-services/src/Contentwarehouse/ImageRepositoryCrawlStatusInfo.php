...
class ImageRepositoryCrawlStatusInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(ImageRepositoryCrawlStatusInfo::class, 'Google_Service_Contentwarehouse_ImageRepositoryCrawlStatusInfo');
