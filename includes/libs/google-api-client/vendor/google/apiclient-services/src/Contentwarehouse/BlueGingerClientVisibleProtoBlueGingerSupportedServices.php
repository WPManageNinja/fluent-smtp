...
class BlueGingerClientVisibleProtoBlueGingerSupportedServices extends \Google\Collection
{
  ...
  /**
   * @return BlueGingerClientVisibleProtoBlueGingerSupportedServicesBlueGingerModule[]
   */
...
class_alias(BlueGingerClientVisibleProtoBlueGingerSupportedServices::class, 'Google_Service_Contentwarehouse_BlueGingerClientVisibleProtoBlueGingerSupportedServices');
