...
class AssistantDevicesPlatformProtoProviderOpenCapability extends \Google\Model
{
   ...
   */
  public function setClientOpProperty(AssistantApiClientOpPropertiesProviderOpenClientOpProperty $clientOpProperty)
  {
    $this->clientOpProperty = $clientOpProperty;
  }
  /**
   * @return AssistantApiClientOpPropertiesProviderOpenClientOpProperty
   */
...
class_alias(AssistantDevicesPlatformProtoProviderOpenCapability::class, 'Google_Service_Contentwarehouse_AssistantDevicesPlatformProtoProviderOpenCapability');
