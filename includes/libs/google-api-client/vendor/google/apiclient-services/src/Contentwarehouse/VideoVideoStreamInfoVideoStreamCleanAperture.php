...
class VideoVideoStreamInfoVideoStreamCleanAperture extends \Google\Model
{
  /**
   * @var int
   */
...
class_alias(VideoVideoStreamInfoVideoStreamCleanAperture::class, 'Google_Service_Contentwarehouse_VideoVideoStreamInfoVideoStreamCleanAperture');
