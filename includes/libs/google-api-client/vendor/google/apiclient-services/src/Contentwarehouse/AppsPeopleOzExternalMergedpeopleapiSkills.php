...
class AppsPeopleOzExternalMergedpeopleapiSkills extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiSkills::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiSkills');
