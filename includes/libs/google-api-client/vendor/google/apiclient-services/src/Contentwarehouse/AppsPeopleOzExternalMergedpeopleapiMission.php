...
class AppsPeopleOzExternalMergedpeopleapiMission extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiMission::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiMission');
