...
class GeostoreLocaleProto extends \Google\Collection
{
  ...
  /**
   * @param GeostoreLocaleLanguageProto[]
   */
  ...
  /**
   * @return GeostoreLocaleLanguageProto[]
   */
...
class_alias(GeostoreLocaleProto::class, 'Google_Service_Contentwarehouse_GeostoreLocaleProto');
