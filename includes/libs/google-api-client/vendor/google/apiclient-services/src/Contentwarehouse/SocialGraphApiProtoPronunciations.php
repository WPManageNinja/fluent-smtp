...
class SocialGraphApiProtoPronunciations extends \Google\Collection
{
  ...
  /**
   * @return SocialGraphApiProtoPronunciation[]
   */
...
class_alias(SocialGraphApiProtoPronunciations::class, 'Google_Service_Contentwarehouse_SocialGraphApiProtoPronunciations');
