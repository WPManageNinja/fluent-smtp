...
class ImageRepositoryShoppingProductInformation extends \Google\Collection
{
  ...
  /**
   * @return ImageRepositoryShoppingProductInformationVersionedProductInformationSet[]
   */
...
class_alias(ImageRepositoryShoppingProductInformation::class, 'Google_Service_Contentwarehouse_ImageRepositoryShoppingProductInformation');
