...
class GoogleInternalAppsWaldoV1alphaWorkingHours extends \Google\Collection
{
  ...
  /**
   * @return GoogleInternalAppsWaldoV1alphaAvailabilityPeriod[]
   */
...
class_alias(GoogleInternalAppsWaldoV1alphaWorkingHours::class, 'Google_Service_Contentwarehouse_GoogleInternalAppsWaldoV1alphaWorkingHours');
