...
class ImageDataMultibangEntities extends \Google\Collection
{
  ...
  /**
   * @return ImageDataMultibangEntitiesMultibangEntity[]
   */
...
class_alias(ImageDataMultibangEntities::class, 'Google_Service_Contentwarehouse_ImageDataMultibangEntities');
