...
class RepositoryWebrefWebrefOutlinkInfos extends \Google\Collection
{
   ...
   */
  public function setOutlinkInfo($outlinkInfo)
  {
    $this->outlinkInfo = $outlinkInfo;
  }
  /**
   * @return RepositoryWebrefWebrefOutlinkInfo[]
   */
  public function getOutlinkInfo()
  {
...
class_alias(RepositoryWebrefWebrefOutlinkInfos::class, 'Google_Service_Contentwarehouse_RepositoryWebrefWebrefOutlinkInfos');
