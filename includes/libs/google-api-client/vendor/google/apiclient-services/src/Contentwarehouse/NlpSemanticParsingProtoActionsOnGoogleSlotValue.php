...
class NlpSemanticParsingProtoActionsOnGoogleSlotValue extends \Google\Collection
{
  ...
  /**
   * @return NlpSemanticParsingProtoActionsOnGoogleSlotValueSingleValue[]
   */
...
class_alias(NlpSemanticParsingProtoActionsOnGoogleSlotValue::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingProtoActionsOnGoogleSlotValue');
