...
class WebutilHtmlTypesSafeHtmlProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(WebutilHtmlTypesSafeHtmlProto::class, 'Google_Service_Contentwarehouse_WebutilHtmlTypesSafeHtmlProto');
