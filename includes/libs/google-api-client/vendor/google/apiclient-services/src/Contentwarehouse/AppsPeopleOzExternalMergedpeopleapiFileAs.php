...
class AppsPeopleOzExternalMergedpeopleapiFileAs extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiFileAs::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiFileAs');
