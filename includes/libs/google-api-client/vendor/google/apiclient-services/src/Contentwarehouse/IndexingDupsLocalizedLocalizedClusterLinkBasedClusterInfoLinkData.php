...
class IndexingDupsLocalizedLocalizedClusterLinkBasedClusterInfoLinkData extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(IndexingDupsLocalizedLocalizedClusterLinkBasedClusterInfoLinkData::class, 'Google_Service_Contentwarehouse_IndexingDupsLocalizedLocalizedClusterLinkBasedClusterInfoLinkData');
