...
class DrishtiQuantizedDenseFeatureData extends \Google\Collection
{
...
class_alias(DrishtiQuantizedDenseFeatureData::class, 'Google_Service_Contentwarehouse_DrishtiQuantizedDenseFeatureData');
