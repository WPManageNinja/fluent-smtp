...
class IndexingConverterRedirectChain extends \Google\Collection
{
  ...
  /**
   * @return IndexingConverterRedirectChainHop[]
   */
...
class_alias(IndexingConverterRedirectChain::class, 'Google_Service_Contentwarehouse_IndexingConverterRedirectChain');
