...
class QualityActionsCustomizedNotificationButton extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(QualityActionsCustomizedNotificationButton::class, 'Google_Service_Contentwarehouse_QualityActionsCustomizedNotificationButton');
