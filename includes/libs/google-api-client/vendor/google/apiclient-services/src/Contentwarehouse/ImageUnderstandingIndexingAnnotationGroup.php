...
class ImageUnderstandingIndexingAnnotationGroup extends \Google\Collection
{
  ...
  /**
   * @return ImageUnderstandingIndexingAnnotation[]
   */
...
class_alias(ImageUnderstandingIndexingAnnotationGroup::class, 'Google_Service_Contentwarehouse_ImageUnderstandingIndexingAnnotationGroup');
