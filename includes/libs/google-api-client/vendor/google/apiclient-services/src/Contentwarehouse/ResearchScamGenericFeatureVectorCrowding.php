...
class ResearchScamGenericFeatureVectorCrowding extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(ResearchScamGenericFeatureVectorCrowding::class, 'Google_Service_Contentwarehouse_ResearchScamGenericFeatureVectorCrowding');
