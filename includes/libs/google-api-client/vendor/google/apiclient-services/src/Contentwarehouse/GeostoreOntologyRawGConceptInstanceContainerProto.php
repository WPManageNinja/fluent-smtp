...
class GeostoreOntologyRawGConceptInstanceContainerProto extends \Google\Collection
{
  ...
  /**
   * @return GeostoreOntologyRawGConceptInstanceProto[]
   */
...
class_alias(GeostoreOntologyRawGConceptInstanceContainerProto::class, 'Google_Service_Contentwarehouse_GeostoreOntologyRawGConceptInstanceContainerProto');
