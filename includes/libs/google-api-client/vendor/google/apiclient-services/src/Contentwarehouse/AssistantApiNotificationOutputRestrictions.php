...
class AssistantApiNotificationOutputRestrictions extends \Google\Model
{
   ...
   */
  public function setOptOutState(AssistantApiNotificationOutputRestrictionsOptOutState $optOutState)
  {
    $this->optOutState = $optOutState;
  }
  /**
   * @return AssistantApiNotificationOutputRestrictionsOptOutState
   */
  public function getOptOutState()
  {
...
class_alias(AssistantApiNotificationOutputRestrictions::class, 'Google_Service_Contentwarehouse_AssistantApiNotificationOutputRestrictions');
