...
class GeostoreOperationsProto extends \Google\Collection
{
   ...
   */
  public function setTemporaryClosure($temporaryClosure)
  {
    $this->temporaryClosure = $temporaryClosure;
  }
  /**
   * @return GeostoreTemporaryClosureProto[]
   */
  public function getTemporaryClosure()
  {
...
class_alias(GeostoreOperationsProto::class, 'Google_Service_Contentwarehouse_GeostoreOperationsProto');
