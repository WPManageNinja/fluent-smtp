...
class QualityNsrExperimentalNsrTeamData extends \Google\Collection
{
   ...
   */
  public function setVersionedSignals($versionedSignals)
  {
    $this->versionedSignals = $versionedSignals;
  }
  /**
   * @return QualityNsrExperimentalNsrTeamScoringSignal[]
   */
  public function getVersionedSignals()
  {
    return $this->versionedSignals;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(QualityNsrExperimentalNsrTeamData::class, 'Google_Service_Contentwarehouse_QualityNsrExperimentalNsrTeamData');
