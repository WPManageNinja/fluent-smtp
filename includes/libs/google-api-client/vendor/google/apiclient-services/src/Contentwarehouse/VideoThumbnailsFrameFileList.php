...
class VideoThumbnailsFrameFileList extends \Google\Collection
{
   ...
   */
  public function setFrameFiles($frameFiles)
  {
    $this->frameFiles = $frameFiles;
  }
  /**
   * @return VideoThumbnailsFrameFile[]
   */
...
class_alias(VideoThumbnailsFrameFileList::class, 'Google_Service_Contentwarehouse_VideoThumbnailsFrameFileList');
