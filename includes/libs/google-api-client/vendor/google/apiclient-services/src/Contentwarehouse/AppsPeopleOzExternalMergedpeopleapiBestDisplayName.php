...
class AppsPeopleOzExternalMergedpeopleapiBestDisplayName extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiBestDisplayName::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiBestDisplayName');
