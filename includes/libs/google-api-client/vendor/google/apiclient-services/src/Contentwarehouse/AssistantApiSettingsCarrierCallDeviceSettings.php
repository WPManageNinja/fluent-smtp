...
class AssistantApiSettingsCarrierCallDeviceSettings extends \Google\Model
{
  /**
   * @var bool
   */
...
class_alias(AssistantApiSettingsCarrierCallDeviceSettings::class, 'Google_Service_Contentwarehouse_AssistantApiSettingsCarrierCallDeviceSettings');
