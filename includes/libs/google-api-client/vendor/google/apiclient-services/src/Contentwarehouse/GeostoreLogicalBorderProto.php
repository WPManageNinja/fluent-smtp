...
class GeostoreLogicalBorderProto extends \Google\Collection
{
   ...
   */
  public function setBorderSegment($borderSegment)
  {
   ...
   */
  public function getBorderSegment()
  {
    return $this->borderSegment;
  }
  /**
   * @param string
   */
...
class_alias(GeostoreLogicalBorderProto::class, 'Google_Service_Contentwarehouse_GeostoreLogicalBorderProto');
