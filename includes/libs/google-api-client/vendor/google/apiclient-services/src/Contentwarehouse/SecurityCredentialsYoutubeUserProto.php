...
class SecurityCredentialsYoutubeUserProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsYoutubeUserProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsYoutubeUserProto');
