...
class NlpSemanticParsingProtoActionsOnGoogleSlotList extends \Google\Collection
{
...
class_alias(NlpSemanticParsingProtoActionsOnGoogleSlotList::class, 'Google_Service_Contentwarehouse_NlpSemanticParsingProtoActionsOnGoogleSlotList');
