...
class MediaIndexVideoCentroid extends \Google\Collection
{
   ...
   */
  public function setDomainScores($domainScores)
  {
    $this->domainScores = $domainScores;
  }
  /**
   * @return MediaIndexVideoCentroidDomainScore[]
   */
  public function getDomainScores()
  {
...
class_alias(MediaIndexVideoCentroid::class, 'Google_Service_Contentwarehouse_MediaIndexVideoCentroid');
