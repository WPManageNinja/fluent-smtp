...
class GeostoreFieldMetadataProto extends \Google\Model
{
   ...
   */
  public function setInternal(GeostoreInternalFieldMetadataProto $internal)
  {
    $this->internal = $internal;
  }
  /**
   * @return GeostoreInternalFieldMetadataProto
   */
...
class_alias(GeostoreFieldMetadataProto::class, 'Google_Service_Contentwarehouse_GeostoreFieldMetadataProto');
