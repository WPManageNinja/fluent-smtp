...
class AppsPeopleOzExternalMergedpeopleapiTagline extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiTagline::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiTagline');
