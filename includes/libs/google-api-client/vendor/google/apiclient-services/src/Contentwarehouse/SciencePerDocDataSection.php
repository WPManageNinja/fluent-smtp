...
class SciencePerDocDataSection extends \Google\Model
{
  /**
   * @var int
   */
...
class_alias(SciencePerDocDataSection::class, 'Google_Service_Contentwarehouse_SciencePerDocDataSection');
