...
class KnowledgeAnswersIntentQueryQrefAnnotationSignals extends \Google\Model
{
  public $score;
...
class_alias(KnowledgeAnswersIntentQueryQrefAnnotationSignals::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersIntentQueryQrefAnnotationSignals');
