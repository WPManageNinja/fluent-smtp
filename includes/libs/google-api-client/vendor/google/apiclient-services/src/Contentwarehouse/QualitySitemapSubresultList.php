...
class QualitySitemapSubresultList extends \Google\Collection
{
   ...
   */
  public function setSubresult($subresult)
  {
    $this->subresult = $subresult;
  }
  /**
   * @return QualitySitemapSubresult[]
   */
...
class_alias(QualitySitemapSubresultList::class, 'Google_Service_Contentwarehouse_QualitySitemapSubresultList');
