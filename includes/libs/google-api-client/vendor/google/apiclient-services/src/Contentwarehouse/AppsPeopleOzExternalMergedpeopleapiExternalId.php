...
class AppsPeopleOzExternalMergedpeopleapiExternalId extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiExternalId::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiExternalId');
