...
class VideoVideoStreamInfoTimedTextStream extends \Google\Collection
{
...
class_alias(VideoVideoStreamInfoTimedTextStream::class, 'Google_Service_Contentwarehouse_VideoVideoStreamInfoTimedTextStream');
