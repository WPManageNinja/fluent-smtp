...
class CrowdingPerDocData extends \Google\Collection
{
   ...
   */
  public function setNewscluster($newscluster)
  {
    $this->newscluster = $newscluster;
  }
  /**
   * @return CrowdingPerDocDataNewsCluster[]
   */
  public function getNewscluster()
  {
...
class_alias(CrowdingPerDocData::class, 'Google_Service_Contentwarehouse_CrowdingPerDocData');
