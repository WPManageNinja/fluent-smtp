...
class SocialGraphApiProtoContactState extends \Google\Model
{
  ...
  /**
   * @param SocialGraphApiProtoContactDeletionContext
   */
  public function setDeletionContext(SocialGraphApiProtoContactDeletionContext $deletionContext)
  {
   ...
   */
  public function getDeletionContext()
  {
    return $this->deletionContext;
  }
  /**
   * @param string
   */
...
class_alias(SocialGraphApiProtoContactState::class, 'Google_Service_Contentwarehouse_SocialGraphApiProtoContactState');
