...
class RepositoryWebrefDomainSpecificRepresentation extends \Google\Model
{
   ...
   */
  public function setEntityData(Proto2BridgeMessageSet $entityData)
  {
...
class_alias(RepositoryWebrefDomainSpecificRepresentation::class, 'Google_Service_Contentwarehouse_RepositoryWebrefDomainSpecificRepresentation');
