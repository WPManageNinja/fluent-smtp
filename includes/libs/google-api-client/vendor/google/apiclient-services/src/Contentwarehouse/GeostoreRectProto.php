...
class GeostoreRectProto extends \Google\Model
{
   ...
   */
  public function setHi(GeostorePointProto $hi)
  {
    $this->hi = $hi;
  }
  /**
   ...
   * @param GeostorePointProto
   */
  public function setLo(GeostorePointProto $lo)
  {
    $this->lo = $lo;
  }
  /**
...
class_alias(GeostoreRectProto::class, 'Google_Service_Contentwarehouse_GeostoreRectProto');
