...
class AppsPeopleOzExternalMergedpeopleapiNickname extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiNickname::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiNickname');
