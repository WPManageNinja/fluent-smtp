...
class AppsPeopleOzExternalMergedpeopleapiPersonAttribute extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AppsPeopleOzExternalMergedpeopleapiPersonAttribute::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiPersonAttribute');
