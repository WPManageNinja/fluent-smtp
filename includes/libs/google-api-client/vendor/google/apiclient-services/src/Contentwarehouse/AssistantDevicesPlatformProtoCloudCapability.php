...
class AssistantDevicesPlatformProtoCloudCapability extends \Google\Collection
{
   ...
   */
  public function setCloudEndpoints($cloudEndpoints)
  {
...
class_alias(AssistantDevicesPlatformProtoCloudCapability::class, 'Google_Service_Contentwarehouse_AssistantDevicesPlatformProtoCloudCapability');
