...
class AppsPeopleOzExternalMergedpeopleapiOccupation extends \Google\Model
{
...
class_alias(AppsPeopleOzExternalMergedpeopleapiOccupation::class, 'Google_Service_Contentwarehouse_AppsPeopleOzExternalMergedpeopleapiOccupation');
