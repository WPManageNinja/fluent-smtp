...
class GeoOndemandAssistantSupportedActions extends \Google\Model
{
   ...
   * @param bool
   */
  public function setAllowsGuestCheckout($allowsGuestCheckout)
  {
   ...
   * @return bool
   */
  public function getAllowsGuestCheckout()
  {
    return $this->allowsGuestCheckout;
  }
  /**
   * @param bool
   */
