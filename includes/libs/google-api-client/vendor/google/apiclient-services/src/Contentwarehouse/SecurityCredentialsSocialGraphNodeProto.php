...
class SecurityCredentialsSocialGraphNodeProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsSocialGraphNodeProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsSocialGraphNodeProto');
