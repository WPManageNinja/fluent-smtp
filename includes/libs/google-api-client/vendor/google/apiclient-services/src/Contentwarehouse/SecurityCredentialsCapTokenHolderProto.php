...
class SecurityCredentialsCapTokenHolderProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsCapTokenHolderProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsCapTokenHolderProto');
