...
class CopleySubreferenceResolution extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(CopleySubreferenceResolution::class, 'Google_Service_Contentwarehouse_CopleySubreferenceResolution');
