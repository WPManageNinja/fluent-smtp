...
class RepositoryWebrefEntityNameSource extends \Google\Collection
{
...
class_alias(RepositoryWebrefEntityNameSource::class, 'Google_Service_Contentwarehouse_RepositoryWebrefEntityNameSource');
