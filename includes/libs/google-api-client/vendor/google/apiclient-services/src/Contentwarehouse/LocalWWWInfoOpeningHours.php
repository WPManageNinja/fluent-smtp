...
class LocalWWWInfoOpeningHours extends \Google\Model
{
   ...
   * @param string
   */
  public function setHoursFprint($hoursFprint)
  {
   ...
   * @return string
   */
  public function getHoursFprint()
  {
    return $this->hoursFprint;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(LocalWWWInfoOpeningHours::class, 'Google_Service_Contentwarehouse_LocalWWWInfoOpeningHours');
