...
class AssistantApiCoreTypesIosAppInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(AssistantApiCoreTypesIosAppInfo::class, 'Google_Service_Contentwarehouse_AssistantApiCoreTypesIosAppInfo');
