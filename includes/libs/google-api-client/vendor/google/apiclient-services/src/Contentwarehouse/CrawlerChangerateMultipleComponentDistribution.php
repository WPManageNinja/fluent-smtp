...
class CrawlerChangerateMultipleComponentDistribution extends \Google\Collection
{
  ...
  /**
   * @return CrawlerChangerateSingleComponentDistribution[]
   */
...
class_alias(CrawlerChangerateMultipleComponentDistribution::class, 'Google_Service_Contentwarehouse_CrawlerChangerateMultipleComponentDistribution');
