...
class RepositoryWebrefLexicalAnnotation extends \Google\Collection
{
   ...
   */
  public function setLexicalRange($lexicalRange)
  {
    $this->lexicalRange = $lexicalRange;
  }
  /**
   * @return RepositoryWebrefLexicalRange[]
   */
  public function getLexicalRange()
  {
    return $this->lexicalRange;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(RepositoryWebrefLexicalAnnotation::class, 'Google_Service_Contentwarehouse_RepositoryWebrefLexicalAnnotation');
