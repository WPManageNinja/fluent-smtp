...
class SecurityCredentialsZwiebackSessionProto extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(SecurityCredentialsZwiebackSessionProto::class, 'Google_Service_Contentwarehouse_SecurityCredentialsZwiebackSessionProto');
