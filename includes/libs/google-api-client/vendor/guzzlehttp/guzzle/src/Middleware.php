...
use FluentMailLib\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('FluentMailLib\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
