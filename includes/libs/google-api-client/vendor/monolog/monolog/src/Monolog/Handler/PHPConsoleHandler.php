...
use FluentMailLib\PhpConsole\Connector;
use FluentMailLib\PhpConsole\Handler;
use FluentMailLib\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('FluentMailLib\\PhpConsole\\Connector')) {
