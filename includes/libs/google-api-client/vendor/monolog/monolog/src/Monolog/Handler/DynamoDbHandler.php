...
use FluentMailLib\Aws\Sdk;
use FluentMailLib\Aws\DynamoDb\DynamoDbClient;
use FluentMailLib\Aws\DynamoDb\Marshaler;
use FluentMailLib\Monolog\Formatter\ScalarFormatter;
