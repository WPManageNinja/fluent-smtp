...
namespace FluentMailLib\Psr\Log\Test;

use FluentMailLib\Psr\Log\LoggerInterface;
use FluentMailLib\Psr\Log\LogLevel;
/**
 ...
 */
abstract class LoggerInterfaceTest extends \FluentMailLib\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->assertInstanceOf('FluentMailLib\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FluentMailLib\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FluentMailLib\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
    ...
    {
        $context = array('bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new DummyTest()), 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r'));
