 ...
 */
class ChannelLevelActivationStrategy implements \FluentSmtpLib\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \FluentSmtpLib\Monolog\Logger::toMonologLevel($defaultActionLevel);
