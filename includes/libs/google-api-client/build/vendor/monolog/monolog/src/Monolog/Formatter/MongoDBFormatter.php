 ...
 */
class MongoDBFormatter implements \FluentSmtpLib\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \FluentSmtpLib\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \FluentSmtpLib\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
