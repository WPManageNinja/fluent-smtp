 ...
 */
class FilterHandler extends \FluentSmtpLib\Monolog\Handler\Handler implements \FluentSmtpLib\Monolog\Handler\ProcessableHandlerInterface, \FluentSmtpLib\Monolog\ResettableInterface, \FluentSmtpLib\Monolog\Handler\FormattableHandlerInterface
{
     ...
     */
    public function __construct($handler, $minLevelOrList = \FluentSmtpLib\Monolog\Logger::DEBUG, $maxLevel = \FluentSmtpLib\Monolog\Logger::EMERGENCY, bool $bubble = \true)
    {
     ...
     * @phpstan-param Level|LevelName|LogLevel::*                                    $maxLevel
     */
    public function setAcceptedLevels($minLevelOrList = \FluentSmtpLib\Monolog\Logger::DEBUG, $maxLevel = \FluentSmtpLib\Monolog\Logger::EMERGENCY) : self
    {
        if (\is_array($minLevelOrList)) {
            $acceptedLevels = \array_map('Monolog\\Logger::toMonologLevel', $minLevelOrList);
        } else {
            $minLevelOrList = \FluentSmtpLib\Monolog\Logger::toMonologLevel($minLevelOrList);
            $maxLevel = \FluentSmtpLib\Monolog\Logger::toMonologLevel($maxLevel);
            $acceptedLevels = \array_values(\array_filter(\FluentSmtpLib\Monolog\Logger::getLevels(), function ($level) use($minLevelOrList, $maxLevel) {
