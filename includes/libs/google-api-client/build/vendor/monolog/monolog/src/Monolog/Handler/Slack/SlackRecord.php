 ...
 */
namespace FluentSmtpLib\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), ?\FluentSmtpLib\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FluentSmtpLib\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \FluentSmtpLib\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \FluentSmtpLib\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \FluentSmtpLib\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FluentSmtpLib\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \FluentSmtpLib\Monolog\Utils::DEFAULT_JSON_FLAGS) : \FluentSmtpLib\Monolog\Utils::jsonEncode($normalized, \FluentSmtpLib\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\FluentSmtpLib\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
