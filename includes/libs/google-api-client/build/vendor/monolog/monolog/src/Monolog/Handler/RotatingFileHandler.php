 ...
 */
class RotatingFileHandler extends \FluentSmtpLib\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \FluentSmtpLib\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \FluentSmtpLib\Monolog\Utils::canonicalizePath($filename);
