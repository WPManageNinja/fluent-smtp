 ...
 */
class OverflowHandler extends \FluentSmtpLib\Monolog\Handler\AbstractHandler implements \FluentSmtpLib\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\FluentSmtpLib\Monolog\Logger::DEBUG => 0, \FluentSmtpLib\Monolog\Logger::INFO => 0, \FluentSmtpLib\Monolog\Logger::NOTICE => 0, \FluentSmtpLib\Monolog\Logger::WARNING => 0, \FluentSmtpLib\Monolog\Logger::ERROR => 0, \FluentSmtpLib\Monolog\Logger::CRITICAL => 0, \FluentSmtpLib\Monolog\Logger::ALERT => 0, \FluentSmtpLib\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\FluentSmtpLib\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \FluentSmtpLib\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
