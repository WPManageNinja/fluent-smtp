...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FluentSmtpLib\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \FluentSmtpLib\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \FluentSmtpLib\Monolog\Logger
    {
