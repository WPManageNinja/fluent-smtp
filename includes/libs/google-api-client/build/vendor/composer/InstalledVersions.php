 ...
 */
namespace FluentSmtpLib\Composer;

use FluentSmtpLib\Composer\Autoload\ClassLoader;
use FluentSmtpLib\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('FluentSmtpLib\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
