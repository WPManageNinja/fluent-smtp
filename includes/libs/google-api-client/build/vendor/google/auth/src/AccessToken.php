...
class AccessToken
{
    ...
    public function verify($token, array $options = [])
    {
        ...
        try {
            ...
            // firebase/php-jwt 3+
        } catch (\FluentSmtpLib\SignatureInvalidException $e) {
            // firebase/php-jwt 2
    ...
    {
        // @codeCoverageIgnoreStart
        if (!\class_exists('FluentSmtpLib\\SimpleJWT\\JWT')) {
    ...
    {
        $class = \class_exists('FluentSmtpLib\\Firebase\\JWT\\JWT') ? 'Firebase\\JWT\\JWT' : 'JWT';
