...
class ImpersonatedServiceAccountCredentials extends \FluentSmtpLib\Google\Auth\CredentialsLoader implements \FluentSmtpLib\Google\Auth\SignBlobInterface
{
    use IamSignerTrait;
    /**
     * @var string
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->sourceCredentials = new \FluentSmtpLib\Google\Auth\Credentials\UserRefreshCredentials($scope, $jsonKey['source_credentials']);
    }
    /**
