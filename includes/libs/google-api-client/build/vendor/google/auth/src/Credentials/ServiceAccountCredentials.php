...
use FluentSmtpLib\Google\Auth\ServiceAccountSignerTrait;
 ...
 */
class ServiceAccountCredentials extends \FluentSmtpLib\Google\Auth\CredentialsLoader implements \FluentSmtpLib\Google\Auth\GetQuotaProjectInterface, \FluentSmtpLib\Google\Auth\SignBlobInterface, \FluentSmtpLib\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($scope, $jsonKey, $sub = null, $targetAudience = null)
    {
        ...
        $this->auth = new \FluentSmtpLib\Google\Auth\OAuth2(['audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI, 'additionalClaims' => $additionalClaims]);
    ...
    private function createJwtAccessCredentials()
    {
        if (!$this->jwtAccessCredentials) {
            ...
            $this->jwtAccessCredentials = new \FluentSmtpLib\Google\Auth\Credentials\ServiceAccountJwtAccessCredentials($credJson, $this->auth->getScope());
        }
