...
trait IamSignerTrait
{
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false, $accessToken = null)
    {
        ...
        $signer = $this->iam;
        if (!$signer) {
            $signer = $this instanceof \FluentSmtpLib\Google\Auth\GetUniverseDomainInterface ? new \FluentSmtpLib\Google\Auth\Iam($httpHandler, $this->getUniverseDomain()) : new \FluentSmtpLib\Google\Auth\Iam($httpHandler);
        }
