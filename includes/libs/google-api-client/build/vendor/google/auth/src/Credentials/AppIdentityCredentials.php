 ...
 */
use FluentSmtpLib\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \FluentSmtpLib\Google\Auth\CredentialsLoader implements \FluentSmtpLib\Google\Auth\SignBlobInterface, \FluentSmtpLib\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(?callable $httpHandler = null)
    {
        ...
        $token = \FluentSmtpLib\google\appengine\api\app_identity\AppIdentityService::getAccessToken($this->scope);
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        $this->checkAppEngineContext();
        /** @phpstan-ignore-next-line */
        return \base64_encode(\FluentSmtpLib\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(?callable $httpHandler = null)
    {
        ...
        /** @phpstan-ignore-next-line */
        return \FluentSmtpLib\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(?callable $httpHandler = null)
    {
        ...
        if (!$this->clientName) {
            /** @phpstan-ignore-next-line */
            $this->clientName = \FluentSmtpLib\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('FluentSmtpLib\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
