...
use DomainException;
use FluentSmtpLib\Google\AccessToken\Revoke;
use FluentSmtpLib\Google\AccessToken\Verify;
use FluentSmtpLib\Google\Auth\ApplicationDefaultCredentials;
...
use FluentSmtpLib\Google\Http\REST;
use FluentSmtpLib\GuzzleHttp\Client as GuzzleClient;
use FluentSmtpLib\GuzzleHttp\ClientInterface;
use FluentSmtpLib\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use FluentSmtpLib\Monolog\Handler\StreamHandler as MonologStreamHandler;
use FluentSmtpLib\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
