...
abstract class OpenSSH extends \FluentSmtpLib\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (isset($parsed['paddedKey'])) {
            ...
            list($p, $q, $g, $y, $x, $comment) = \FluentSmtpLib\phpseclib3\Common\Functions\Strings::unpackSSH2('i5s', $parsed['paddedKey']);
            return \compact('p', 'q', 'g', 'y', 'x', 'comment');
        }
        list($p, $q, $g, $y) = \FluentSmtpLib\phpseclib3\Common\Functions\Strings::unpackSSH2('iiii', $parsed['publicKey']);
    ...
    public static function savePublicKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $p, \FluentSmtpLib\phpseclib3\Math\BigInteger $q, \FluentSmtpLib\phpseclib3\Math\BigInteger $g, \FluentSmtpLib\phpseclib3\Math\BigInteger $y, array $options = [])
    {
        ...
        // mpint     g
        // mpint     y
        $DSAPublicKey = \FluentSmtpLib\phpseclib3\Common\Functions\Strings::packSSH2('siiii', 'ssh-dss', $p, $q, $g, $y);
    ...
    public static function savePrivateKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $p, \FluentSmtpLib\phpseclib3\Math\BigInteger $q, \FluentSmtpLib\phpseclib3\Math\BigInteger $g, \FluentSmtpLib\phpseclib3\Math\BigInteger $y, \FluentSmtpLib\phpseclib3\Math\BigInteger $x, $password = '', array $options = [])
    {
        ...
        $privateKey = \FluentSmtpLib\phpseclib3\Common\Functions\Strings::packSSH2('si5', 'ssh-dss', $p, $q, $g, $y, $x);
