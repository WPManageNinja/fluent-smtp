 ...
 */
namespace FluentSmtpLib\phpseclib3\Common\Functions;

use FluentSmtpLib\ParagonIE\ConstantTime\Base64;
use FluentSmtpLib\ParagonIE\ConstantTime\Base64UrlSafe;
use FluentSmtpLib\ParagonIE\ConstantTime\Hex;
...
abstract class Strings
{
    ...
    public static function unpackSSH2($format, &$data)
    {
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                case 'i':
                    $result[] = new \FluentSmtpLib\phpseclib3\Math\BigInteger($temp, -256);
                    break;
                case 's':
                    $result[] = $temp;
                    break;
        ...
        for ($i = 0; $i < \strlen($format); $i++) {
            ...
            switch ($format[$i]) {
                ...
                case 's':
                    ...
                    break;
                case 'i':
                    if (!$element instanceof \FluentSmtpLib\phpseclib3\Math\BigInteger && !$element instanceof \FluentSmtpLib\phpseclib3\Math\Common\FiniteField\Integer) {
    ...
    {
        return \function_exists('sodium_base642bin') ? \sodium_base642bin($data, \SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING, '=') : \FluentSmtpLib\ParagonIE\ConstantTime\Base64::decode($data);
    }
    /**
    ...
    public static function base64url_decode($data)
    {
        ...
        return \function_exists('sodium_base642bin') ? \sodium_base642bin($data, \SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING, '=') : \FluentSmtpLib\ParagonIE\ConstantTime\Base64UrlSafe::decode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_bin2base64') ? \sodium_bin2base64($data, \SODIUM_BASE64_VARIANT_ORIGINAL) : \FluentSmtpLib\ParagonIE\ConstantTime\Base64::encode($data);
    }
    /**
    ...
    public static function base64url_encode($data)
    {
        ...
        return \function_exists('sodium_bin2base64') ? \sodium_bin2base64($data, \SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING) : \FluentSmtpLib\ParagonIE\ConstantTime\Base64UrlSafe::encode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_hex2bin') ? \sodium_hex2bin($data) : \FluentSmtpLib\ParagonIE\ConstantTime\Hex::decode($data);
    }
    /**
    ...
    {
        return \function_exists('sodium_bin2hex') ? \sodium_bin2hex($data) : \FluentSmtpLib\ParagonIE\ConstantTime\Hex::encode($data);
    }
}
