...
abstract class PKCS8 extends \FluentSmtpLib\phpseclib3\Crypt\Common\Formats\Keys\PKCS8
{
    ...
    public static function load($key, $password = '')
    {
        ...
        switch (\true) {
            ...
            case !$decoded[0]['content'] instanceof \FluentSmtpLib\phpseclib3\Math\BigInteger:
                throw new \RuntimeException('Unable to decode BER of parameters');
        }
     ...
     * @return string
     */
    public static function savePrivateKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $prime, \FluentSmtpLib\phpseclib3\Math\BigInteger $base, \FluentSmtpLib\phpseclib3\Math\BigInteger $privateKey, \FluentSmtpLib\phpseclib3\Math\BigInteger $publicKey, $password = '', array $options = [])
    {
        ...
        $key = \FluentSmtpLib\phpseclib3\File\ASN1::encodeDER($privateKey, ['type' => \FluentSmtpLib\phpseclib3\File\ASN1::TYPE_INTEGER]);
     ...
     * @return string
     */
    public static function savePublicKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $prime, \FluentSmtpLib\phpseclib3\Math\BigInteger $base, \FluentSmtpLib\phpseclib3\Math\BigInteger $publicKey, array $options = [])
    {
        $params = ['prime' => $prime, 'base' => $base];
        $params = \FluentSmtpLib\phpseclib3\File\ASN1::encodeDER($params, \FluentSmtpLib\phpseclib3\File\ASN1\Maps\DHParameter::MAP);
        $params = new \FluentSmtpLib\phpseclib3\File\ASN1\Element($params);
        $key = \FluentSmtpLib\phpseclib3\File\ASN1::encodeDER($publicKey, ['type' => \FluentSmtpLib\phpseclib3\File\ASN1::TYPE_INTEGER]);
