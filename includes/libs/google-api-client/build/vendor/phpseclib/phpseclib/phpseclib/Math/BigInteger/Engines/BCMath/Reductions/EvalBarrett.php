 ...
 */
namespace FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\BCMath\Reductions;

use FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\BCMath;
use FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\BCMath\Base;
/**
 * PHP Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\BCMath\Base
{
    /**
     ...
     */
    protected static function generateCustomReduction(\FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\BCMath $m, $class)
    {
        $m_length = \strlen($m);
        if ($m_length < 5) {
