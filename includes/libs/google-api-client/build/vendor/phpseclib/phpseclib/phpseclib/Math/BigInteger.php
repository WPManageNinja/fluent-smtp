...
use FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = '\\FluentSmtpLib\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
        ...
        if (!$fqmain::isValidEngine()) {
            throw new \FluentSmtpLib\phpseclib3\Exception\BadConfigurationException("{$main} is not setup correctly on this system");
        }
        ...
        if (!$found) {
            throw new \FluentSmtpLib\phpseclib3\Exception\BadConfigurationException("No valid modular exponentiation engine found for {$main}");
        }
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\FluentSmtpLib\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function subtract(\FluentSmtpLib\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\FluentSmtpLib\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function modInverse(\FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\FluentSmtpLib\phpseclib3\Math\BigInteger $e, \FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\FluentSmtpLib\phpseclib3\Math\BigInteger $e, \FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\FluentSmtpLib\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\FluentSmtpLib\phpseclib3\Math\BigInteger $min, \FluentSmtpLib\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\FluentSmtpLib\phpseclib3\Math\BigInteger $min, \FluentSmtpLib\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\FluentSmtpLib\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\FluentSmtpLib\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\FluentSmtpLib\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\FluentSmtpLib\phpseclib3\Math\BigInteger $min, \FluentSmtpLib\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\FluentSmtpLib\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\FluentSmtpLib\phpseclib3\Math\BigInteger $x) use($func) {
