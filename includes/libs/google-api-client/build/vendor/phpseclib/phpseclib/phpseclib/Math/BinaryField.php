...
use FluentSmtpLib\phpseclib3\Math\BinaryField\Integer;
 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class BinaryField extends \FluentSmtpLib\phpseclib3\Math\Common\FiniteField
{
    /**
     * Instance Counter
     *
    ...
    public function __construct(...$indices)
    {
        ...
        \FluentSmtpLib\phpseclib3\Math\BinaryField\Integer::setModulo($this->instanceID, $modulo);
        \FluentSmtpLib\phpseclib3\Math\BinaryField\Integer::setRecurringModuloFunction($this->instanceID, $reduce);
        $this->randomMax = new \FluentSmtpLib\phpseclib3\Math\BigInteger($modulo, 2);
    }
    /**
    ...
    {
        return new \FluentSmtpLib\phpseclib3\Math\BinaryField\Integer($this->instanceID, $num instanceof \FluentSmtpLib\phpseclib3\Math\BigInteger ? $num->toBytes() : $num);
    }
    /**
    ...
    public function randomInteger()
    {
        ...
        return new \FluentSmtpLib\phpseclib3\Math\BinaryField\Integer($this->instanceID, \FluentSmtpLib\phpseclib3\Math\BigInteger::randomRange($one, $this->randomMax)->toBytes());
    }
    /**
    ...
    {
        return \strlen(\FluentSmtpLib\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID));
    }
    /**
    ...
    {
        return \strlen(\FluentSmtpLib\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID)) << 3;
    }
    /**
    ...
    {
        $str = \FluentSmtpLib\phpseclib3\Common\Functions\Strings::bits2bin($x);
        $pad = \strlen($x) >> 3;
        if (\strlen($x) & 3) {
            $pad++;
        }
    ...
    public static function base256ToBase2($x)
    {
        ...
        return \FluentSmtpLib\phpseclib3\Common\Functions\Strings::bin2bits($x);
    }
}
