...
abstract class MontgomeryPrivate
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $components['dA'] = new \FluentSmtpLib\phpseclib3\Math\BigInteger($key, 256);
     ...
     * @return string
     */
    public static function savePrivateKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $privateKey, \FluentSmtpLib\phpseclib3\Crypt\EC\BaseCurves\Montgomery $curve, array $publicKey, $secret = null, $password = '')
    {
        if (!empty($password) && \is_string($password)) {
            throw new \FluentSmtpLib\phpseclib3\Exception\UnsupportedFormatException('MontgomeryPrivate private keys do not support encryption');
        }
