 ...
 */
namespace FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP;
use FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
