...
abstract class libsodium
{
     ...
     * @return string
     */
    public static function savePublicKey(\FluentSmtpLib\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey)
    {
     ...
     * @return string
     */
    public static function savePrivateKey(\FluentSmtpLib\phpseclib3\Math\BigInteger $privateKey, \FluentSmtpLib\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey, $secret = null, $password = '')
    {
        if (!isset($secret)) {
        ...
        if (!empty($password) && \is_string($password)) {
            throw new \FluentSmtpLib\phpseclib3\Exception\UnsupportedFormatException('libsodium private keys do not support encryption');
        }
