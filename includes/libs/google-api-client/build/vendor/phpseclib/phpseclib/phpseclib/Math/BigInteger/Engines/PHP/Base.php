 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Base extends \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP
{
    /**
     * Cache constants
     *
     ...
     * @return PHP
     */
    protected static function powModHelper(\FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP $x, \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP $e, \FluentSmtpLib\phpseclib3\Math\BigInteger\Engines\PHP $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = [1];
