...
abstract class Random
{
    ...
    public static function string($length)
    {
        ...
        if ($crypto === \false) {
            ...
            switch (\true) {
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\AES'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\AES('ctr');
                    break;
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\Twofish'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\Twofish('ctr');
                    break;
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\Blowfish'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\Blowfish('ctr');
                    break;
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\TripleDES'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\TripleDES('ctr');
                    break;
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\DES'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\DES('ctr');
                    break;
                case \class_exists('FluentSmtpLib\\phpseclib3\\Crypt\\RC4'):
                    $crypto = new \FluentSmtpLib\phpseclib3\Crypt\RC4();
                    break;
                default:
