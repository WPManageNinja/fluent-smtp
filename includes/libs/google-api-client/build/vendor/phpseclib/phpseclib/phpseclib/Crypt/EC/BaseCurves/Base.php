...
abstract class Base
{
     ...
     * @return object
     */
    public function convertInteger(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
    ...
    public function createRandomMultiplier()
    {
        ...
        return \FluentSmtpLib\phpseclib3\Math\BigInteger::randomRange($one, $this->order->subtract($one));
    }
    /**
     ...
     * Sets the Order
     */
    public function setOrder(\FluentSmtpLib\phpseclib3\Math\BigInteger $order)
    {
        $this->order = $order;
    }
    /**
