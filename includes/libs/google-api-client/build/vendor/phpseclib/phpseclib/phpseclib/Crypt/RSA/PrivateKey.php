 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
final class PrivateKey extends \FluentSmtpLib\phpseclib3\Crypt\RSA implements \FluentSmtpLib\phpseclib3\Crypt\Common\PrivateKey
{
     ...
     */
    private function rsadp(\FluentSmtpLib\phpseclib3\Math\BigInteger $c)
    {
     ...
     * @return bool|BigInteger
     */
    private function rsasp1(\FluentSmtpLib\phpseclib3\Math\BigInteger $m)
    {
     ...
     * @return BigInteger
     */
    protected function exponentiate(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
        switch (\true) {
        ...
        if (!static::$enableBlinding) {
            ...
            $r = \FluentSmtpLib\phpseclib3\Math\BigInteger::randomRange(self::$one, $smallest->subtract(self::$one));
     ...
     * @return BigInteger
     */
    private function blind(\FluentSmtpLib\phpseclib3\Math\BigInteger $x, \FluentSmtpLib\phpseclib3\Math\BigInteger $r, $i)
    {
    ...
    private function emsa_pss_encode($m, $emBits)
    {
        ...
        $salt = \FluentSmtpLib\phpseclib3\Crypt\Random::string($sLen);
    ...
    public function getPublicKey()
    {
        ...
        return \FluentSmtpLib\phpseclib3\Crypt\RSA::loadFormat('PKCS8', $key)->withHash($this->hash->getHash())->withMGFHash($this->mgfHash->getHash())->withSaltLength($this->sLen)->withLabel($this->label)->withPadding($this->signaturePadding | $this->encryptionPadding);
    }
    /**
