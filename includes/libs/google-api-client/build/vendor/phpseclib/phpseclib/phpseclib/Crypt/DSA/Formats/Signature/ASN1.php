...
abstract class ASN1
{
    ...
    public static function load($sig)
    {
        ...
        $components = \FluentSmtpLib\phpseclib3\File\ASN1::asn1map($decoded[0], \FluentSmtpLib\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
        return $components;
    }
    /**
    ...
    {
        return \FluentSmtpLib\phpseclib3\File\ASN1::encodeDER(\compact('r', 's'), \FluentSmtpLib\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
    }
}
