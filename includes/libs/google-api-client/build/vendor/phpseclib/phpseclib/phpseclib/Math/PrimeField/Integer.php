 ...
 */
namespace FluentSmtpLib\phpseclib3\Math\PrimeField;
...
class Integer extends \FluentSmtpLib\phpseclib3\Math\Common\FiniteField\Integer
{
     ...
     * @return void
     */
    public static function setModulo($instanceID, \FluentSmtpLib\phpseclib3\Math\BigInteger $modulo)
    {
    ...
    public static function setRecurringModuloFunction($instanceID, callable $function)
    {
        ...
        if (!isset(static::$zero[static::class])) {
            static::$zero[static::class] = new \FluentSmtpLib\phpseclib3\Math\BigInteger();
        }
    }
    /**
     ...
     * @return static
     */
    public function pow(\FluentSmtpLib\phpseclib3\Math\BigInteger $x)
    {
        $temp = new static($this->instanceID);
    ...
    public function squareRoot()
    {
        ...
        $q = clone $p_1;
        $s = \FluentSmtpLib\phpseclib3\Math\BigInteger::scan1divide($q);
        ...
        $m = new \FluentSmtpLib\phpseclib3\Math\BigInteger($s);
    ...
    {
        $w++;
        $mask = new \FluentSmtpLib\phpseclib3\Math\BigInteger((1 << $w) - 1);
        $sub = new \FluentSmtpLib\phpseclib3\Math\BigInteger(1 << $w);
