...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \FluentSmtpLib\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\FluentSmtpLib\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\FluentSmtpLib\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\FluentSmtpLib\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\FluentSmtpLib\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
