...
use FluentSmtpLib\GuzzleHttp\Handler\CurlHandler;
use FluentSmtpLib\GuzzleHttp\Handler\CurlMultiHandler;
use FluentSmtpLib\GuzzleHttp\Handler\Proxy;
use FluentSmtpLib\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \FluentSmtpLib\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
    ...
    {
        return \sprintf('GuzzleHttp/%d', \FluentSmtpLib\GuzzleHttp\ClientInterface::MAJOR_VERSION);
    }
    /**
...
EOT
    ...
    {
        if (\strlen($host) === 0) {
            throw new \FluentSmtpLib\GuzzleHttp\Exception\InvalidArgumentException('Empty host provided');
        }
     ...
     * @internal
     */
    public static function idnUriConvert(\FluentSmtpLib\Psr\Http\Message\UriInterface $uri, int $options = 0) : \FluentSmtpLib\Psr\Http\Message\UriInterface
    {
        if ($uri->getHost()) {
            ...
            if ($asciiHost === \false) {
                ...
                throw new \FluentSmtpLib\GuzzleHttp\Exception\InvalidArgumentException($errorMessage);
            }
