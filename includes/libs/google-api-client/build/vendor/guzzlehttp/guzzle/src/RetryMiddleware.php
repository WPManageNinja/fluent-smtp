...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\FluentSmtpLib\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\FluentSmtpLib\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\FluentSmtpLib\Psr\Http\Message\RequestInterface $request, array $options, ?\FluentSmtpLib\Psr\Http\Message\ResponseInterface $response = null) : \FluentSmtpLib\GuzzleHttp\Promise\PromiseInterface
    {
