...
final class FnStream implements \FluentSmtpLib\Psr\Http\Message\StreamInterface
{
     ...
     * @return FnStream
     */
    public static function decorate(\FluentSmtpLib\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
