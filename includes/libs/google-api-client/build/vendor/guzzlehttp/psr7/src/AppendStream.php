 ...
 */
final class AppendStream implements \FluentSmtpLib\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\FluentSmtpLib\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \FluentSmtpLib\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
