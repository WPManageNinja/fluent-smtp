...
final class StreamWrapper
{
     ...
     */
    public static function getResource(\FluentSmtpLib\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\FluentSmtpLib\Psr\Http\Message\StreamInterface $stream)
    {
