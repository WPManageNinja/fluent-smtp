 ...
 */
class Response implements \FluentSmtpLib\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \FluentSmtpLib\Psr\Http\Message\ResponseInterface
    {
