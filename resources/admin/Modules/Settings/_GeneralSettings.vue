        ...
        <el-form class="fss_compact_form" :data="settings.misc" label-position="top">
            ...
            <el-form-item v-if="settings.misc.log_emails == 'yes' && !!appVars.has_fluentcrm"
                ...
                <el-checkbox v-model="settings.misc.disable_fluentcrm_logs" true-label="yes" false-label="no">
                    {{ $t('Disable Logging for FluentCRM Emails') }}
                </el-checkbox>
            </el-form-item>
            ...
            <el-form-item :label="$t('Email Simulation')">
                <el-checkbox
                    ...
                    true-label="yes"
                    false-label="no"
                >{{ $t('__Email_Simulation_Label') }}
                </el-checkbox>
                <p style="color: red;" v-if="settings.misc.simulate_emails == 'yes'">
                    {{ $t('__Email_Simulation_Yes') }}</p>
                <p v-if="appVars.is_disabled_defined" style="color: red;">
                    {{ ('Emails are being simulated due to the definition of ') }}
                    <b>FLUENTMAIL_SIMULATE_EMAILS</b>{{ (' in your PHP code.') }}</p>
            </el-form-item>
