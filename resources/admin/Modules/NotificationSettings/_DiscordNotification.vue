<template>
    <div>
        <div v-if="!isConfigured">
            <div>
                <p>
                    Get real-time notification on your Discord Channel on any email sending failure. Configure
                    notification with Discord to start getting real time notifications. <a target="_blank"
                                                                                           rel="noopener"
                                                                                           href="https://fluentsmtp.com/docs/email-sending-error-notification-discord/">Read
                    the documentation</a>.
                </p>
                <el-form class="fss_compact_form" :data="newForm" label-position="top">
                    <el-form-item label="Your Discord Channel Name (For Internal Use)">
                        <el-input size="small" v-model="newForm.channel_name"/>
                    </el-form-item>

                    <el-form-item label="Your Discord Channel Webhook URL">
                        <el-input size="small" v-model="newForm.webhook_url" placeholder="Discord Webhook URL"/>
                    </el-form-item>
