...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            '__PUSHOVER_INTRO' => "Pushover makes it easy to get real-time notifications on your Android, iPhone, iPad, and Desktop",
            '__PUSHOVER_NOTIFICATION_ENABLED' => "Pushover channel is enabled",
