...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'Both modes use HTTPS only. FluentSMTP does not automatically retry a failed submission.' => __('Both modes use HTTPS only. FluentSMTP does not automatically retry a failed submission.', 'fluent-smtp'),
            ...
            'Channel' => __('Channel', 'fluent-smtp'),
            ...
            'Configure' => __('Configure', 'fluent-smtp'),
            ...
            'Create an Email API key in the MailChannels Console, then publish the SPF, DKIM, and DMARC records for the sender domain.' => __('Create an Email API key in the MailChannels Console, then publish the SPF, DKIM, and DMARC records for the sender domain.', 'fluent-smtp'),
            ...
            'Direct — wait for per-message acceptance results' => __('Direct — wait for per-message acceptance results', 'fluent-smtp'),
            ...
            'Disabled' => __('Disabled', 'fluent-smtp'),
            ...
            'Enabled' => __('Enabled', 'fluent-smtp'),
            ...
            'MailChannels Email API Settings' => __('MailChannels Email API Settings', 'fluent-smtp'),
            ...
            'Open MailChannels Console' => __('Open MailChannels Console', 'fluent-smtp'),
            ...
            'Queued — return after MailChannels accepts the request' => __('Queued — return after MailChannels accepts the request', 'fluent-smtp'),
            ...
            'Submission mode' => __('Submission mode', 'fluent-smtp'),
