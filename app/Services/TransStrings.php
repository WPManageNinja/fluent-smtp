...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'By disabling encryption, your API key will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.' => __('By disabling encryption, your API key will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.', 'fluent-smtp'),
            'By disabling encryption, your Application Client Secret will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.' => __('By disabling encryption, your Application Client Secret will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.', 'fluent-smtp'),
            'By disabling encryption, your Secret Key will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.' => __('By disabling encryption, your Secret Key will be stored in plain text in the database. This is not recommended for security reasons. Enable only if your security plugin rotate WP SALTS frequently.', 'fluent-smtp'),
            ...
            'Configure Pushover Notification' => __('Configure Pushover Notification', 'fluent-smtp'),
            ...
            'Disable Encryption for Application Client Secret Key (Not Recommended)' => __('Disable Encryption for Application Client Secret Key (Not Recommended)', 'fluent-smtp'),
            ...
            'Failed to deactivate channel' => __('Failed to deactivate channel', 'fluent-smtp'),
            ...
            'No activity found.' => __('No activity found.', 'fluent-smtp'),
            ...
            'Security Failed. Please reload the page' => __('Security Failed. Please reload the page', 'fluent-smtp'),
            ...
            'Validation Failed' => __('Validation Failed', 'fluent-smtp'),
