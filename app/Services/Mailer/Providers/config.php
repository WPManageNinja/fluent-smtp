...
return [
    ...
    'providers'   => [
        ...
        'elasticmail' => [
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/configure-elastic-email-in-fluent-smtp/">Read the documentation</a> for how to configure Elastic Email with FluentSMTP.'
        ],
        'gmail'       => [
            'key'      => 'gmail',
